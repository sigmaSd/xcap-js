 ...
 * # xcap-js
 *
 * A cross-platform screen capture library for Deno, providing bindings to the Rust xcap library.
 * This module allows capturing screenshots from multiple monitors on Windows, macOS, and Linux.
 *
 * ## Usage Example
 *
 * @example
 * ```typescript
 * import { getMonitors, captureMonitor, savePng } from "jsr:@sigma/xcap-js";
 *
